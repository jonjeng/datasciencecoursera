...
#
# This plot shows that yes, the total emissions from Pm2.5 have decreased in Baltimore City, Maryland from 1999 to 2008. The sum of emissions does not monotonically decrease but overall, there is a substantial decrease in emissions totals over the period.
