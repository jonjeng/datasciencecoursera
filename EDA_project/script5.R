...
#
# The resulting figure shows that emissions from motor vehicle sources in Baltimore City have decreased from 1999 to 2008. The first subplot shows that total emissions have decreased substantially, whereas the second subplot shows that in addition, variance in measurement has decreased dramatically.
...
dev.copy(png, 'figure5.png', width=640)
dev.off()
