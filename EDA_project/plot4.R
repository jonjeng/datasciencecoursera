...
#
# The resulting plot shows that while total emissions from coal combustion-related sources have decreased from 1999 to 2008, though the individual measurements have, for the most part, worsened.
...
dev.copy(png, 'plot4.png', width=960, height=640)
dev.off()
