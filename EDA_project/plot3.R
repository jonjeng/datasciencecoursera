...
#
# The plot shows that there were overall decreases in nonpoint, non-road, and on-road sources of pollution in Baltimore City. Emissions from point sources of pollution were not consistent but overall, an increase occurred.
...
dev.copy(png, 'plot3.png', width=640)
dev.off()
